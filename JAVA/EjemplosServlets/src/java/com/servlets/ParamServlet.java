    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getMethod().equals("GET")) {
                ...
                out.println("<form name='form1' method='post' action='http://localhost:8084/EjemplosServlets/param'>");
                ...
                out.println("<input type='number' name='edad' size='25' value=''/> </td></tr>");
                out.println("<tr><td>Email: </td><td>");
                out.println("<input type='email' name='email' size='25' value=''/> </td></tr>");
                out.println("</table>");
                out.println("<input type='submit' value='Enviar'/>");

            } else if (request.getMethod().equals("POST")) {
                out.println("<title>Leyendo Parametros</title>");
                out.println("</head>");
                out.println("<body>");
                out.println("<h1>Devolviendo sus datos</h1>");
                out.print("<p>Petición URL: "+request.getContextPath()+ "</p>");
